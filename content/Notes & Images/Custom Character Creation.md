*The reson i stole from CROWN and SKULL is essentially the system below*. 

[[Hero Points]] are used to ‘buy’ every detail. In this pages you’ll find everything you need to build a fully custom character. If you have an idea that isn’t listed, just work with your GM to add new bits.
...
***STEP 3: [[Core Ability|Core Ability]]***: Choose a core ability and deduct **20 points** for its acquisition. This is one of the most useful mechanical aspects of your character, and **you can only ever choose one**, so choose wisely! 
- **You can also choose NONE** here and save the **20 points** for other ideas.

***STEP 4: [[Additional Health|Add Health]]***: *Is your character resilient?* There are two types of [[Health]] in **SoC**, [[Health|Character's Health]] and [[Equiped Gears's Health|Gear's Health]], you can spend hero points to make your character more resilient, or later to buy him some good armor. 
- [[Health]] in *SoC* is made out of "blocks" of different value, when hit, you need to mark a total value of blocks-of-health equal or greater than the received damage. 
