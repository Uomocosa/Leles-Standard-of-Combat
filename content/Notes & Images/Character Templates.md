...
- **Flaw**: [[SoC • Flaw - Stubborn|Stubborn]], [[SoC • Flaw - Employed|Employed]].
- **Core Ability**: [[SoC • Core Ability - Battlemaster|Battlemaster]] (choosen skill [[Force]]).
- ***[[Additional Health]]***: **3**.<br>Your total [[Health]] is:
	...
	- [ ] ***1***. (_**[[Health|Character's Health]]**_)
	- [ ] ***1***. (_**[[Health|Character's Health]]**_)
- **Skills**: [[Force]] **7** (***+3***), [[Forging]] **5** (***+2***), [[Will]] **3** (***+1***), [[Lore]] **3** (***+1***).<br>***NOTE***: _The first number rempresents the number of [[Hero Points|points]] in that [[Skills|Skill]], the second number between parentesis is the cooresponding [[Skills|Skill Modifier]].<br>The [[SoC • Core Ability - Battlemaster|Battlemaster]] skill-bonus to [[Force]] is already accounted for_.
- **Equipment**: Choose **10 pts** of [[Basic Equipment List|basic equipment]] and [[Basic Armaments List|basic armaments]].

----
### Adventurer
You are a nomad, a hunter, a road-walker. You thrive in the ruins and wilderness, seeking treasures and truths.
- **Flaw**: [[SoC • Flaw - Grudge|Grudge]], [[SoC • Flaw - Impetuos|Impetuos]]
- **Core Ability**: [[SoC • Core Ability - Uncanny Shot|Uncanny Shot]].
- ***[[Additional Health]]***: **2**.<br>Your total [[Health]] is:
	- [ ] ***3***. (_**[[Health|Character's Health]]**_)
	- [ ] ***3***. (_**[[Health|Character's Health]]**_)
	- [ ] ***2***. (_**[[Health|Character's Health]]**_)
	- [ ] ***2***. (_**[[Health|Character's Health]]**_)
...
- **Flaw**: [[Flaw - Timid|Timid]]. 
- **Core Ability**: None.
- ***[[Additional Health]]***: **1**.<br>Your total [[Health]] is:
	- [ ] ***3***. (_**[[Health|Character's Health]]**_)
	- [ ] ***2***. (_**[[Health|Character's Health]]**_)
	- [ ] ***1***. (_**[[Health|Character's Health]]**_)
	- [ ] ***1***. (_**[[Health|Character's Health]]**_)
...
- **Flaw**: [[SoC • Flaw - Drunkard|Drunkard]] 
- **Core Ability**: None.
- ***[[Additional Health]]***: **2**.<br>Your total [[Health]] is:
	- [ ] ***3***. (_**[[Health|Character's Health]]**_)
	- [ ] ***3***. (_**[[Health|Character's Health]]**_)
	...
	- [ ] ***1***. (_**[[Health|Character's Health]]**_)
	- [ ] ***1***. (_**[[Health|Character's Health]]**_)
- **Skills**: [[Forging]] 18 (***+7***), [[Force]] **9** (**+4**), [[Persuasion]] **3** (***+1***).
- **Equipment**: Choose **15 pts** of [[Basic Equipment List|basic equipment]] and [[Basic Armaments List|basic armaments]]

----
### Cleric
Yours is the holy path. You represent a higher power, divine will, and the greater good that watches over living things.
- **Flaw**: [[SoC • Flaw - Ascetic|Ascetic]].
- **Core Ability**: [[SoC • Core Ability - Paragon of Faith|Paragon of Faith]].
- ***[[Additional Health]]***: **2**.<br>Your total [[Health]] is:
	- [ ] ***3***. (_**[[Health|Character's Health]]**_)
	- [ ] ***3***. (_**[[Health|Character's Health]]**_)
	- [ ] ***2***. (_**[[Health|Character's Health]]**_)
	...
	- [ ] ***1***. (_**[[Health|Character's Health]]**_)
	- [ ] ***1***. (_**[[Health|Character's Health]]**_)
- **Skills**: [[Faith]] **3** (***+1***), [[Medicine]] **2** (***+0***).
- **Equipment**: Choose **5 pts** of [[Basic Equipment List|basic equipment]] and [[Basic Armaments List|basic armaments]]
- **Spells**: Choose any **3** [[Basic Spells|basic spells]], give one of this spell the [[SoC • Rune - Specialist|Specialist]] [[Custom Spells|Effect]].
...
- **Flaw**: [[SoC • Flaw - Greedy|Greedy]], [[SoC • Flaw - Pursued|Pursued (Guards from a nearby town)]]
- **Core Ability**: [[SoC • Core Ability - Go Unnoticed|Go Unnoticed]]
- ***[[Additional Health]]***: **2**.<br>Your total [[Health]] is:
	- [ ] ***3***. (_**[[Health|Character's Health]]**_)
	- [ ] ***3***. (_**[[Health|Character's Health]]**_)
	- [ ] ***2***. (_**[[Health|Character's Health]]**_)
