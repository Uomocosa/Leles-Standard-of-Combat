...
_However, a critical failure can also be an optimal learning method_.<br>Whenever you roll a [[SoC • Rules - Skill Checks|Skill Check]] and **critically fail**, and have enough points to spend, you can [[Meditate and Train|Meditate or Train]], in that skill.
- ***Train (1 pt)*** — Increase the skill [[SoC • Discord Bot - Thread • SKILLS|Modifier]] by **+1**. Gain **1 [[Type of Cards|Health Card]]**.
- ***Study (2 pt)*** — Increase the skill [[SoC • Discord Bot - Thread • SKILLS|Modifier]] by **+1**. Gain **1 [[Type of Cards|Energy Card]]**.
...
The bad kind (often called ‘cheesing’) employs hard-to-believe or flimsy methods to make things easy or gimp the game. Leaping from a rock to earn a deadly attack? Great. Padding your hero with ham sandwiches to absorb attrition? Not very cool. 
