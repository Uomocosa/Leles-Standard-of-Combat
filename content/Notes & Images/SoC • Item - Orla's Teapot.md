...
aliases:
  - Orla's Teapot
---
- ***Image***:<br>![[SoC • Item - Orla's Teapot (Image).png|222]]
- ***Info***: Item 
- ***Cost***: 15 
- ***Description***:<br>A teapot celebrated in countless street songs, it is said that wherever its owner goes, laughter and cries of joy follow.<br>_Tea Time_ — At any time, you can use this magical teapot to brew a flawless cup of tea. However, the exact flavor is decided by your **GM**. When you pour the tea, the teapot also magically produces cookies that perfectly complement the brew. The teapot has no limit to how much tea and biscuits it can create, and they can fully substitute the [[SoC • Item - Rations|Rations]] you need to survive. ^description
- ***Notes***: ==DO NOT ALLOW THIS ITEM IF YOUR PARTY HAS MANY [[Companions]]==, or as a variant don't allow the tea and biscuits created from *Orla's Teapot* be consumed by [[Companions]], even if they are humans.
- ***Effects***: [[SoC • Rune - Create|Create]], [[SoC • Rune - Lasting|Lasting]]
...
----
- ***Card***:<br>![[SoC • Card - Orlas Teapot.png]]
