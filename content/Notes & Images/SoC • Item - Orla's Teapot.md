...
- ***Notes***: ==DO NOT ALLOW THIS ITEM IF YOUR PARTY HAS MANY [[SoC • Discord Bot - Thread • COMPANIONS]]==.
- ***Flavor***: Upgrades: [[SoC • Spell Effect - Create|Create]], [[SoC • Spell Effect - Lasting|Lasting-4]]
- ***Color***: white 
- ***Rarity***: special
