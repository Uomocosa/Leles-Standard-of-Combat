...
1. A creature or group must remain hidden or unnoticed by their targets. This often requires a successful [[Stealth]] [[Skill Checks|check]].
2. The targets make [[Perception]] [[Skill Checks|check]] to detect the ambush. If they fail to notice the threat, they are surprised.
