...
While [[SoC • Rules Chapter - HEALTH|Health]] and [[SoC • Rules Chapter - SKILLS|Skills]] are the same as for a player, ***TACTICS***: represent their attacks and special effects.

While for more complex enemies you can just create a new character using an appropriate number of [[SoC • Rules Chapter - NEW CAMPAIGN|points]].<br>*As a GM i only use simple enemies, but you do you*.
