...
aliases:
  ...
  - Enemy Primer
---
***Simple Enemies have 3 STATS: HP, AC, SKILLS***.
***Also they have a "stat" called TACTICS***, this represents their attacks and special effects.

While for more complex enemies you can just create a new character using an appropiate number of [[Hero Points|points]].<br>*As a GM i only use simple enemies, but you do you*.
...
_What about a final boss? You can come up with a special attack just for him, take 1,2,...10 random [[Custom Spells|Custom Spell Effects]], meld them togheter and describe its attack/s, also does it draws its power from [[Nature]], or maybe is an ancient evil priest with a lot of [[Faith]] in his God._

----
Here's some simple enemyies examples:
